...
# ----------------------------------------------------------------------------
DATA_PATH = "data/rse_july_2026_clean.csv"
...
try:
    df_raw, quality_report = load_data(DATA_PATH)
except FileNotFoundError:
    st.error(f"Could not find the dataset at `{DATA_PATH}`. Please make sure the data file is in place.")
    st.stop()
